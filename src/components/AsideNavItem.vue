...
export default {
  ...
  computed: {
    active () {
      return this.nav[this.valueKey] && this.value === this.nav[this.valueKey] ? 'active' : ''
    }
  },

  methods: {
    onClick () {
      this.$emit('onClick', this.nav)
    }
  }
}
</script>
